...
Jedes Modul besteht aus einem grundlegenden (CORE) und/oder einem erweiterten (ADVANCED) Teil. Für jeden Teil ist definiert, wie du die geforderten Kompetenzen nachweisen kannst. 
...
- **Nicht genügend (5)**: mindestens ein CORE Teil ist nicht erfüllt.
...
Die geforderten Kompetenzen werden in der Regel durch Abgabegespräche über abgegebene Übungsaufgaben oder durch Aufgaben in PLFs nachgewiesen. Der Nachweis ist nicht frei wählbar, sondern wird im jeweiligen Modul definiert.
...
- grundlegende Programmierkonzepte werden verwechselt oder falsch eingesetzt
- Fehler können nicht sinnvoll analysiert werden
- Anwendung gelingt auch bei einfachen/vertrauten Anforderungen nicht ausreichend
...
- Bei einer Veränderung der Aufgabe ist die Übertragung noch schwierig.
...
- Ansatz fehlt oder ist grundlegend falsch: Die Aufgabe wurde nicht verstanden.
...
- Vereinzelt Mängel: Unsaubere Variablenbenennung, fehlende Randfall-Prüfung oder kleiner Logikfehler bei Nebenbedingungen.

### 🟢 Gänzlich erfüllt

- Vollständige Funktionalität: Der Code löst auch komplexere Anforderungen korrekt und deckt auch Randfälle (Edge Cases, z. B. 0, negative Zahlen, leeres Array) ab.
- Saubere Struktur & Effizienz: Logischer, gut lesbarer Aufbau ohne unnötigen Code.
- Qualität: Gute Benennung von Variablen/Funktionen, ggf. sinnvolle Kommentare oder richtige Datentyp-Wahl.
